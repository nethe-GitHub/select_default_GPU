@ECHO off 
REM Program generated batch file, aim to make the system use OpenGL ICD of Intel(R) HD Graphics 630
REG ADD "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\OpenGLDrivers\MSOGL" /f /reg:64 || ECHO Failed Must run %~dp0%select_GL_C.bat as admin. && Pause && EXIT /b -1
(REG ADD "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\OpenGLDrivers\MSOGL" /f /reg:32
REG ADD "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\OpenGLDrivers\MSOGL" /f /reg:64 /v DLL /d C:\WINDOWS\System32\DriverStore\FileRepository\nvacig.inf_amd64_853524551286f4d6\nvoglv64.dll
REG ADD "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\OpenGLDrivers\MSOGL" /f /reg:32 /v DLL /d C:\WINDOWS\System32\DriverStore\FileRepository\nvacig.inf_amd64_853524551286f4d6\nvoglv32.dll
